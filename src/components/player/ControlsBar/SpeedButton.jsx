...
export default function SpeedButton({ speed, onClick }) {
    return (
        <button
            type="button"
            onClick={onClick}
            className="flex h-11 items-center justify-center gap-2 rounded-xl border border-gray-800 bg-slate-900 px-4 text-slate-100 transition focus-visible:ring-4 focus-visible:ring-white/60 active:scale-95"
        >
            ...
            <span className="font-bold text-sm">سرعت: {speed}x</span>
        </button>
    )
}
